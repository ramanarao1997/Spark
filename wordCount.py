...
# if a map() was used new RDD would only have elements as lines of words (as the original RDD)
...
for result in results:
    ...
    # convert to ascii (for proper display in case other encodings were used)
